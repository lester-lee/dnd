...
**Sleep.** Each target must make a Wisdom saving throw and falls unconscious for 10 min on a failed save. A creature awakens if it takes damage or if someone uses an action to shake or slap it awake.
